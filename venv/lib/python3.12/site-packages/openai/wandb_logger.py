...
class WandbLogger:
    ...
    def sync(
        ...
        **kwargs_wandb_init,
        ...
        if id:
            fine_tune = client.fine_tunes.retrieve(id=id)
    ...
    def _log_fine_tune(
        ...
        **kwargs_wandb_init,
        ...
        try:
            ...
            results = client.files.download(id=results_id).decode("utf-8")
        except:
            if show_individual_warnings:
    ...
    def _log_artifact_inputs(cls, file, prefix, artifact_type, project, entity):
        ...
        if artifact is None:
            # get file content
            try:
                file_content = client.files.download(id=file_id).decode("utf-8")
            except:
                print(

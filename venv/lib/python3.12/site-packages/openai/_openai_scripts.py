...
def main():
    ...
    # TODO: The 'openai.debug' option isn't read in the client API. You will need to pass it when you instantiate the client, e.g. 'OpenAI(debug=True)'
    # openai.debug = True
    if args.api_key is not None:
    if args.api_base is not None:
        # TODO: The 'openai.api_base' option isn't read in the client API. You will need to pass it when you instantiate the client, e.g. 'OpenAI(base_url=args.api_base)'

...
class ChatCompletion:
    ...
    def create(cls, args):
        ...
        resp = client.chat.completions.create(# Required
        model=args.model,
        messages=messages,
        # Optional
        n=args.n,
...
class Completion:
    ...
    def create(cls, args):
        ...
        resp = client.completions.create(engine=args.engine,
        model=args.model,
        n=args.n,
...
class Model:
    @classmethod
    def get(cls, args):
        resp = client.models.retrieve(id=args.id)
        print(resp)

    @classmethod
    def delete(cls, args):
        model = client.models.delete(args.id)
        print(model)
...
class File:
    ...
    def create(cls, args):
        ...
        resp = client.files.create(file=buffer_reader,
    ...
    @classmethod
    def get(cls, args):
        resp = client.files.retrieve(id=args.id)
        print(resp)

    @classmethod
    def delete(cls, args):
        file = client.files.delete(args.id)
        print(file)
...
class Image:
    @classmethod
    def create(cls, args):
        resp = client.images.generate(prompt=args.prompt,
        size=args.size,
        n=args.num_images,
    ...
    def create_variation(cls, args):
        with open(args.image, "rb") as file_reader:
            buffer_reader = BufferReader(file_reader.read(), desc="Upload progress")
        resp = client.images.generate(image=buffer_reader,
        size=args.size,
        n=args.num_images,
        response_format=args.response_format)
        print(resp)
    ...
    def create_edit(cls, args):
        ...
        resp = client.images.generate(image=image_reader,
        mask=mask_reader,
        prompt=args.prompt,
        size=args.size,
        n=args.num_images,
...
class Audio:
    ...
    def transcribe(cls, args):
        ...
        resp = client.audio.transcribe_raw(# Required
        model=args.model,
        file=file_reader,
        filename=args.file,
        # Optional
    ...
    def translate(cls, args):
        with open(args.file, "rb") as r:
            file_reader = BufferReader(r.read(), desc="Upload progress")
        resp = client.audio.translate_raw(# Required
        model=args.model,
        file=file_reader,
        filename=args.file,
        # Optional
...
class FineTune:
    ...
    def _maybe_upload_file(
        ...
        if check_if_file_exists:
            bytes = len(content)
            matching_files = client.files.find_matching_files(name=user_provided_file or f.name, bytes=bytes, purpose="fine-tune")
    ...
    def create(cls, args):
        ...
        resp = client.fine_tunes.create(**create_args)
    ...
    @classmethod
    def get(cls, args):
        resp = client.fine_tunes.retrieve(id=args.id)
        print(resp)

    @classmethod
    def results(cls, args):
        fine_tune = client.fine_tunes.retrieve(id=args.id)
        ...
        result_file = client.fine_tunes.retrieve(id=args.id)["result_files"][0]
        resp = client.files.download(id=result_file["id"])
    ...
    def events(cls, args):
        ...
        resp = client.fine_tunes.list_events(id=args.id)  # type: ignore
        print(resp)
    ...
    @classmethod
    def cancel(cls, args):
        resp = client.fine_tunes.cancel(id=args.id)
        print(resp)

    @classmethod
    def delete(cls, args):
        resp = client.fine_tunes.delete(sid=args.id)
        print(resp)
